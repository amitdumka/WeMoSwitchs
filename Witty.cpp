...
{
  digitalWrite(RedLed, r); digitalWrite(GreenLed, g); digitalWrite(BlueLed, b);
}


void Witty::SetLedAnalog(int r, int g, int b)
{
  analogWrite(RedLed, r); analogWrite(GreenLed, g); analogWrite(BlueLed, b);
}
